...
def _resolve_job_payload(
    ...
    if job.kind == "earnings_read":
        ...
        resolved.update({
            ...
            # here and not sniffed on the node. Declared in CAPABILITIES so
            # marketplace number two answers this by adding a line. (The
            # interstitial-wall machinery that used to ride along here was
            # TeePublic's, and left with it on 2026-09-06.)
