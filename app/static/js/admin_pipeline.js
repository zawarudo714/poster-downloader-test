...
(function () {
  ...
  const SETTINGS_GROUPS = {
    ...
    search: [
      ...
      ['min_image_px', 'number', 'Reject below this size (px)',
       'A picture is REFUSED, on every door and with no "save anyway", when it is under this on ANY side. So a saved image is at least this many pixels on both width and height. This is strict on purpose: a tall narrow banner or a wide panorama whose short side is under this is turned away too, even if the long side is large. Set to 0 to switch the check off.'],
    ...
    gpt: [
      ...
      ['openai_background', 'select', 'Background',
